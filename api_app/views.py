...
CONSUMER_KEY = 'W48FhrdBtWpwdwcMfGOCaKtD2k7QRSKxi4nKkGIE'
CONSUMER_SECRET = 'GWUSLnToCVqcVYSaxMYPPoVTP1urr8yarlyZxdsF'

# OSM oauth URLs
BASE_URL = 'http://api06.dev.openstreetmap.org/oauth/'
...
USER_DETAILS_URL = 'http://api06.dev.openstreetmap.org/api/0.6/user/details'
